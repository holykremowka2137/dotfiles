...
alias valac "$VISUAL ~/.config/alacritty/alacritty.yml"
alias vautostart "$VISUAL ~/.config/qtile/autostart.sh"
alias vcol "$VISUAL ~/.config/qtile/colors.py"
alias qconf "$VISUAL ~/.config/qtile/config.py"
alias vfish "$VISUAL ~/.config/fish/config.fish"
alias vlf "$VISUAL ~/.config/lf/lfrc"
alias vrofi "$VISUAL ~/.config/rofi/config.rasi"
