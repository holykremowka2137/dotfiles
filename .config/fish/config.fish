...
abbr v "nvim"
abbr valac "emacsclient -nc -a emacs ~/.config/alacritty/alacritty.yml"
abbr vautostart "emacsclient -nc -a emacs ~/.config/qtile/autostart.sh"
abbr vcol "emacsclient -nc -a emacs ~/.config/qtile/colors.py"
abbr qconf "emacsclient -nc -a emacs ~/.config/qtile/config.py"
abbr vfish "emacsclient -nc -a emacs ~/.config/fish/config.fish"
abbr vlf "emacsclient -nc -a emacs ~/.config/lf/lfrc"
abbr vrofi "emacsclient -nc -a emacs ~/.config/rofi/config.rasi"
abbr vstar "emacsclient -nc -a emacs ~/.config/starship.toml"
